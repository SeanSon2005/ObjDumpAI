    ...
    return (
        <center>
            <div>
                <h2>Your Datasets</h2>
                <br />
                <button onClick={() => setShowModal(true)} class="button">
                    New Dataset
                </button>
                <Spacer size={50} />
                <br />
                            ...
                            <tbody>
                                {datasets.map((dataset, index) => (
                                    <tr key={dataset.id}>
                                        ...
                                        <td>
                                            <button onClick={() => handleVisibilityClick(dataset)} class="button3">
                    ...
                    <div className="modal">
                        <div className="modal-content">
                            ...
                            <form onSubmit={handleDatasetSubmit}>
                                ...
                                <br/>
                                <Spacer size={30} />
                                <button class="button4" type="submit" style={{ color: "white" }}>Create</button>
                            </form>
                        </div>
                    </div>
                )}
                ...
                {showDeleteModal && (
                    <div className="modal">
                        <div className="modal-content">
                            ...
                            <button class="button2" onClick={handleConfirmDelete}  >
                                Yes
                            </button>
                            <button class="button2" onClick={handleCloseDeleteModal} >
                                No
                            </button>
                        </div>
                    </div>
                ...
                {showVisibilityModal && (
                    <div className="modal">
                        <div className="modal-content">
                            ...
                            <h8>Are you sure you want to make the dataset: {selectedDataset?.name} {selectedDataset?.public ? 'private' : 'public'}?</h8>
                            <button class="button2" onClick={handleConfirmToggleVisibility}>Yes
                            </button>
                            &emsp;
                            <button class="button2" onClick={handleCloseVisibilityModal} >
                                No
                            </button>
                        </div>
                    </div>
