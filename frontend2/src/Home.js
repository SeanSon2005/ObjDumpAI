...
function Home() {
  ...
  return (
    <div className="content"> 
     ...
     <center><h6>See your Model in Action!</h6></center>

     <Spacer size={3} />

        <h3><center>&emsp;&emsp;Left: Original Image &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;  Right: Detected Objects</center></h3>
